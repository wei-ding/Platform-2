...
similarity_measure<-function(working_directory,observation_file,index_patient_id,index_attribute){
	...
	create_bins(working_directory,observation_file,index_attribute)         # Run only once for a particular attribute
