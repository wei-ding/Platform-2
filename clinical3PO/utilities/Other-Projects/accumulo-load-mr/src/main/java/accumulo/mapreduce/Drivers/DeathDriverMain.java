...
public class DeathDriverMain extends Configured implements Tool {

	final static Logger logger = Logger.getLogger(DeathDriverMain.class);
	
	public static void main(String[] args) throws Exception {
		
		logger.info("  ACCUMULO FOR DEATH STARTED WITH MAPREDUCE  ");
		System.exit(ToolRunner.run(new DeathDriverMain(), args));
	}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "Accumulo-Death-DbInsert");
		job.setJarByClass(DeathDriverMain.class);
		...
		job.setMapperClass(DeathMapperMainDao.class);
