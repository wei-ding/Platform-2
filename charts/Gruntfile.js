module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        jshint: {
            source: {
                src: ['src/**/*.js','Gruntfile.js', 'spec/**/*.js', 'web/visits.js'],
                options: {
                    indent: 4,
        ...
        watch: {
            ...
            reload: {
                files: ['dw.js', 'dw.css', 'web/js/dw.js', 'web/css/dw.css', 'dw.min.js'],
                options: {
                    livereload: true
                }
            }
        ...
        copy: {
            'dw-to-gh': {
                files: [
                    { expand: true, flatten: true, src: 'dw.css', dest: 'web/css/'},
                    { expand: true,
                      flatten: true,
                      src: [output.js,
                            output.js + ".map",
    ...
    grunt.registerMultiTask('toc', 'Generate a markdown table of contents.', function() {
        ...
        grunt.file.write(destFile, "# dw API\n" + toc +"\n"+ source);
