...
@Controller
@RequestMapping("Visualization/Observation")
public class PatientObservationView {
	...
	public String getPatientObservation(@PathVariable Long id, Model model) {
		
		model.addAttribute("id", id);
		model.addAttribute("type","Observation");
		return "visualization/PatientObservationView";
	}
