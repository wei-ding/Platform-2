...
public class PatientSearch {
	...
	public String getHivePatient(@Valid @ModelAttribute("patientSearchForm") PatientSearchForm patientForm, BindingResult result, Model model) {
		...
		JobSearchDetails jobSearchDetails = new JobSearchDetails();
		jobSearchDetails.setSearchOn(SearchOn.PATIENTIDHIVE.getSearchOn());
		jobSearchDetails.setSearchType("PatientIdHive");
		jobSearchDetails.setSearchParameters(jobSearch.getSearchParameters().get(0).getValue());
		jobSearchDetails.setScriptType(SearchScript.PATIENTIDHIVE.getSearchScript());
		jobSearchDetails.setScriptParameters(jobSearchService.getScriptParameters(jobSearch));
	...
	public String patientSearchHive(ModelMap model) {
		// Allow the user to search for a patient
		model.addAttribute("patientSearchForm", new PatientSearchForm());
