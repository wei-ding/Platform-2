...
public class ConceptDaoObject {

	private static ConceptDaoObject obj = null;
	private static BatchWriter bw = null; 
	final static Logger logger = Logger.getLogger(ConceptDaoObject.class);

	public static synchronized ConceptDaoObject getInstance() {

		if(obj == null) {
			obj = new ConceptDaoObject();
		} 
		return obj;
	}
