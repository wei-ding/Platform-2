...
@Controller
@RequestMapping("Visualization/PatientWithUserPrefs")
public class PatientViewWithUserPrefs {
	...
	public String getPatientView(@PathVariable Long id, Model model) {
		// The id should be passed to the jsp, jsp inturn would pass it to the
		// service.
		model.addAttribute("id", id);
		model.addAttribute("type","PatientWithUserPrefs");
		return "visualization/PatientSearchWithUserPrefsView";
	}
