...
import java.io.IOException; import java.io.InputStream; import java.util.Properties; import java.io.File;
 ...
 * requirements.
 */
public final class dpc3poServer {

  public static void main(final String[] args) throws Exception {

    Properties properties = new Properties();

    InputStream in = dpc3poServer.class.getResourceAsStream("server.properties");
    properties.load(in);
    ...
    final ObjectMapper objectMapper = new ObjectMapper();
      ...
      HttpHandler routes = Handlers.path()
              .addPrefixPath("/projects/dpc3po/parse", new dpc3poHandler(objectMapper))
      ...
      routes = Handlers.header(routes, Headers.SERVER_STRING, "dpc3po Server");
