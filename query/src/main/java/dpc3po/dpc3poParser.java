...
public class dpc3poParser extends Parser {
	...
	public static final int
		RULE_Prescription = 0, RULE_stanza = 1, RULE_verse = 2, RULE_sentence = 3;
	public static final String[] ruleNames = {
		"Prescription", "stanza", "verse", "sentence"
	};

	@Override
	public String getGrammarFileName() { return "dpc3po.g4"; }
	...
	public dpc3poParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class PrescriptionContext extends ParserRuleContext {
		public List<TerminalNode> NEWLINE() { return getTokens(dpc3poParser.NEWLINE); }
		...
		public TerminalNode NEWLINE(int i) {
			return getToken(dpc3poParser.NEWLINE, i);
		}
		public PrescriptionContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_Prescription; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).enterPrescription(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).exitPrescription(this);
		}
	}

	public final PrescriptionContext Prescription() throws RecognitionException {
		PrescriptionContext _localctx = new PrescriptionContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_Prescription);
		int _la;
		try {
	...
	public static class StanzaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).enterStanza(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).exitStanza(this);
		}
	}
	...
	public static class VerseContext extends ParserRuleContext {
		public TerminalNode NEWLINE() { return getToken(dpc3poParser.NEWLINE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).enterVerse(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).exitVerse(this);
		}
	}
	...
	public static class SentenceContext extends ParserRuleContext {
		public List<TerminalNode> WORD() { return getTokens(dpc3poParser.WORD); }
		public List<TerminalNode> COMMA() { return getTokens(dpc3poParser.COMMA); }
		public TerminalNode PUNCTUATION() { return getToken(dpc3poParser.PUNCTUATION, 0); }
		public TerminalNode COMMA(int i) {
			return getToken(dpc3poParser.COMMA, i);
		}
		public TerminalNode WORD(int i) {
			return getToken(dpc3poParser.WORD, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).enterSentence(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof dpc3poListener ) ((dpc3poListener)listener).exitSentence(this);
		}
	}
