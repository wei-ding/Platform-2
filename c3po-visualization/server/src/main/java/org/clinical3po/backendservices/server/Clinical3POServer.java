...
import org.clinical3po.backendservices.server.handler.RestHandler;
import org.clinical3po.backendservices.server.handler.WebSocketHandler;
...
public class Clinical3POServer {

    static final Logger logger = LoggerFactory.getLogger(Clinical3POServer.class);
            ...
            virtualHostHandler
                    .addHost(
                            ...
                            Handlers.predicates(
                                ...
                                , Clinical3POServer.class.getClassLoader()),
    ...
    {
        Runtime.getRuntime().addShutdownHook( new Thread() { public void run() { Clinical3POServer.shutdown(); }});
    }
