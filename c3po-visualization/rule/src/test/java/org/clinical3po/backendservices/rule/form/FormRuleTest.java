...
import org.clinical3po.backendservices.rule.rule.GetRuleDropdownRule;
...
public class FormRuleTest extends TestCase {
    ...
    String getForm = "{\"readOnly\":true,\"category\":\"form\",\"name\":\"getForm\",\"data\":{\"id\":\"org.clinical3po.backendservices.common.test.json\"}}";
    ...
    String delForm = "{\"readOnly\":false,\"category\":\"form\",\"name\":\"delForm\",\"data\":{\"id\":\"org.clinical3po.backendservices.common.test.json\"}}";

    String getDynaForm = "{\"readOnly\":true,\"category\":\"form\",\"name\":\"getForm\",\"data\":{\"host\":\"example\",\"id\":\"org.clinical3po.backendservices.demo.uiselect_d\"}}";
